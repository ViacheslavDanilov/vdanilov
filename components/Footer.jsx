    ...
    <footer className="relative w-full max-w-[1400px] mx-auto flex flex-col items-center justify-center rounded-t-xl border-t border-light/10 bg-[radial-gradient(35%_128px_at_50%_0%,theme(backgroundColor.accent/8%),transparent)] px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
      ...
      <div className="w-full space-y-8">
        ...
        <AnimatedContainer className="space-y-4 text-center lg:text-left">
          ...
          <p className="text-sm text-gray-400 mx-auto lg:mx-0 max-w-xs">
            Tech Lead · Engineering Manager · Research Scientist
          </p>
        </AnimatedContainer>

        {/* Quick Links and Social Links Grid - 2 columns on mobile, 2 on desktop */}
        <div className="grid grid-cols-2 gap-x-8 sm:gap-x-12 lg:gap-x-16 justify-items-center px-8 sm:px-12 lg:px-0 lg:max-w-2xl lg:mx-0">
          {/* Quick Links */}
        ...
        <AnimatedContainer delay={0.4}>
          <div className="pt-6 border-t border-light/10 text-center lg:text-left">
