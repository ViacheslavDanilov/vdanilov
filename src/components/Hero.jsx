    ...
    <section id="hero" className="w-full max-w-7xl mx-auto px-6 py-12 md:py-24">
      <div className="flex flex-col md:flex-row items-center justify-between gap-10">
        ...
        <div className="w-full md:w-1/2 space-y-4 text-center md:text-left">
          <p className="text-lg md:text-xl text-accent font-medium text-cyan-400">
            Hi there, I am
          </p>
          ...
          <h2 className="text-2xl md:text-3xl text-gray-400 min-h-[1.5em] flex items-center justify-center md:justify-start">
            I am a
            <FlipWords words={roles} className="text-white" />
          </h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center md:justify-start gap-4 pt-6">
            <a
              ...
              className="inline-flex items-center bg-cyan-500 text-black px-8 py-3 rounded-full font-medium hover:bg-cyan-400 transition-colors duration-300 shadow-lg hover:shadow-cyan-500/50"
            ...
            <a
              ...
              className="inline-flex items-center border border-gray-600 text-white px-8 py-3 rounded-full font-medium hover:border-cyan-400 hover:text-cyan-400 transition-colors duration-300"
        ...
        <div className="w-full md:w-1/2 flex justify-center md:justify-end">
          <div className="relative w-64 h-64 md:w-[400px] md:h-[400px] rounded-full overflow-hidden border-4 border-cyan-500/20 shadow-2xl bg-black">
            <video
              autoPlay
              muted
              loop
