  ...
  return (
    <div className="min-h-screen pt-24">
      <div className="w-full max-w-5xl mx-auto px-6 py-12 md:py-24">
        <ProjectHeader
          title="DeepVision Wildfire"
          subtitle="Deep learning wildfire detection system for real-time smoke detection in Siberian forests"
          banner={{
            image: "/portfolio/previews/deepvision-wildfire.jpg",
            alt: "DeepVision Wildfire - Real-time wildfire detection system",
          }}
          client={{
            name: "Incom Group",
            url: "https://incom.tomsk.ru/",
            location: "Tomsk · Russia 🇷🇺",
          }}
